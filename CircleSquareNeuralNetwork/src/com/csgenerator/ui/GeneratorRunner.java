...
public class GeneratorRunner extends JFrame {
    ...
    private void initializeNeuralNetworkButtons() {
        ...
        genTestDataBtn.setLocation(530, 285);
        ...
        testImgBtn.setLocation(530, 135);
