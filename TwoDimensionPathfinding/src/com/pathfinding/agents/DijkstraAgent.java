...
public class DijkstraAgent implements IAgent {
	private Point currentLocation;
	private PriorityQueue<Node> fringe;
	private Gameboard board;
	private Point target;

	public DijkstraAgent(Gameboard board) {
		this.board = board;
	...
	public Gameboard Step() {
		...
		double minWeight = minNode.distanceCovered;
		for (Node n : fringe) {
			double curWeight = n.distanceCovered;
	...
	private class Node implements Comparable{
		...
		public int compareTo(Object oNode) {
			...
			double thisAStarValue = distanceCovered;
			double otherAStarValue = otherNode.distanceCovered;
